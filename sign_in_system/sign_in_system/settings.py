"""
Django settings for sign_in_system project.
...
SECRET_KEY = 'django-insecure-@$rk%i&qc+%l!32h9y#sm(7r3*p5@(xs2jyz3+i-l3#%19cw^2'
...
LOGIN_REDIRECT_URL = '/attendance/check/'  # Redirect after successful login
